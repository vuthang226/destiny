...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 09, 2020 lúc 06:11 PM
...
(39, '00000000', 4000000, '2020-05-05', '2020-06-04', NULL, NULL),
(40, 'anloznhe', 4000000, '2020-05-11', '2020-06-10', NULL, NULL);
...
CREATE TABLE `product` (
  ...
  `pd.productDescription` varchar(600) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
('2', 'Nike Air Max 2', 'Nike, Air Max', 'Nike', 'The Nike Air Max 270 combines the exaggerated tongue from the Air Max 180 and classic elements from the Air Max 93. It features Nike\'s biggest heel Air unit yet for a super-soft ride that feels as impossible as it looks.', 4000000, 'airmax2.jpg', 'Men\'s Shoe', NULL, 91, 0, 0),
...
('di mê ban', 'anloznhe', 'dmmmmmm', 'ancutminh@gmail.com', '036428367', '144 xuân thủy');
...
--
ALTER TABLE `orders`
  MODIFY `or.orderNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
